export const Strings = {
  ...
  accountDueDayHelper: 'Day of the month, 1 to 31.',
  accountDueDayPlaceholder: '1–31',
  accountInterestLabel: 'Track interest',
  accountInterestHelper: 'Estimate interest from the APR on the revolving balance.',
  accountAprLabel: 'APR',
  ...
  errDueDayRange: 'Between 1 and 31.',
  ...
  accountDetailArchivedTitle: 'Archived',
  accountDetailArchivedBody: 'Hidden from your dashboard and totals. Its history stays.',
  accountDetailBalanceArchived: 'Balance when archived',
  accountDetailTransactionsLabel: 'Transactions',
  accountDetailCommitmentsLabel: 'Commitments paid from it',
  accountDetailUnarchive: 'Unarchive',
  accountDetailDelete: 'Delete account',
  accountDetailDeleteTitle: (name: string) => `Delete ${name}?`,
  accountDetailDeleteTransactionsNone: 'Nothing is recorded on this account.',
  accountDetailDeleteTransactionsOne: 'Its 1 transaction stays, labelled Deleted Account.',
  accountDetailDeleteTransactionsMany: (count: string) =>
    `Its ${count} transactions stay, labelled Deleted Account.`,
  accountDetailDeleteCommitmentOne: (name: string) => `${name} will need another account.`,
  accountDetailDeleteCommitmentsMany: (count: string) =>
    `${count} commitments will need another account.`,
  accountDetailDeleteClose: 'Keeping it archived keeps its name on all of them.',
  accountDetailDeleteKeep: 'Keep archived',
  accountDetailDeleteConfirm: 'Delete',
  ...
  editAccountNameLabel: 'Name',
  editAccountColorLabel: 'Colour',
  editAccountTypeLabel: 'Type',
  editAccountTypeHelper: 'Set when the account was created.',
  editAccountBalanceHelper: 'Locked. Use Adjust balance for the current balance.',
  ...
  categoriesSaveError: 'Could not save this category. Please try again.',
  ...
  transactionsHeroSpentMore: (pct: string, month: string) => `Spent ${pct}% more than ${month}`,
