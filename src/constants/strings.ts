export const Strings = {
  ...
  budgetToolCopy: 'Copy',
  budgetToolCategory: 'Category',
  budgetToolPlan: 'Plan',
  budgetToolCopyA11y: 'Copy previous month',
  budgetToolPlanComingSoonA11y: 'Spending plans coming in Phase 2',
  budgetCopyTitle: 'Copy previous month',
  ...
  budgetCopyEmptyBody: 'Previous month has no category budgets.',
