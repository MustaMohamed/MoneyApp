...
export const Size = {
  ...
  /** Same ms(56) as `emptyStateIcon` by design; a circle diameter, not a glyph size. Do not dedupe. */
  activityEmptyCircle: ms(56),
  /** The activity card's inline empty block: the glyph drawn inside that circle. */
