...
export function CommitmentFormBody({
  ...
  const formBodyState = useCommitmentFormBodyState();
  const categoryPickerVisible = formBodyState.state.categoryPickerVisible.value;
  const accountPickerVisible = formBodyState.state.accountPickerVisible.value;
  const showStartDatePicker = formBodyState.state.showStartDatePicker.value;
  const showEndDatePicker = formBodyState.state.showEndDatePicker.value;
  const {
