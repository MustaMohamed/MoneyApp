...
export function OnboardingStatusTrack({ footnote, message }: OnboardingStatusTrackProps) {
  ...
  return (
    ...
    >
      ...
      <Typography
        numberOfLines={2}
        // oxlint-disable-next-line moneyapp/font-size-pairs-line-height -- STATUS_TRACK_LINE_HEIGHT is Size.statusTrack/2 (onboarding_shell.geometry.ts:16), sized so exactly two lines fit the fixed track at any device scale; lineHeightFor's 1.3 ratio would not guarantee that.
