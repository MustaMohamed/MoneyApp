...
type CategoriesScreenStoreState = {
  editingCategory: Signal<Category | null>;
  categoryToDelete: Signal<Category | null>;
  linkedCount: Signal<number>;
};
...
export function useCategoriesScreenStore(): {
  state: CategoriesScreenStoreState;
