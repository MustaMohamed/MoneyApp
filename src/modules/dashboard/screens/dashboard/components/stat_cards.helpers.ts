 ...
 * stat_cards.tsx:249's card is always the USD month-spend stat, never any other currency --
 * so this site stays reachable at the corrected mutation locus (src/constants/currency.ts:10-11):
 * `formatCurrencyParts` (format_amount.ts:55-62) reads `CURRENCY_CONFIG[currency].decimals`
