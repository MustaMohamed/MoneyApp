...
4. Wait for my per-item results, then record them under `## Device QA` in the task file `docs/scopes/MA-<scope>/tasks/MA-nnn.md`, using the skill's template, and state the verdict: pass, or fail with the items that route back to step 6.
