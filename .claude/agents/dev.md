...
- **module layout:** canonical feature code lives under `src/modules/<domain>/` with `database/`, `repository/`, `store/`, `screens/`, and optional `components/`. Do not introduce a `data/` folder.
