...
- After the user merges: remove the worktree, delete the local branch, append `## Outcome` to the task file, set `done`, move to the next task. Everything under `docs/scopes/` is kept.
