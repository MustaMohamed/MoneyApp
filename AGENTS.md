...
The project instructions are in [CLAUDE.md](CLAUDE.md). Any coding agent can apply its Commands, Project Structure, Conventions and gotchas, and the rule files in `.claude/rules/` (each one's `paths:` frontmatter names the files it covers).
