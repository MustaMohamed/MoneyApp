...
// Runtime hex — cannot use Tailwind className for these (build-time only)
  ...
  return (
    <Card className="mb-3 rounded-xl p-0" style={{ elevation: 0, shadowOpacity: 0 }}>
      <Card.Body className="gap-0 p-4">
        {/* Header row: label + pct badge + status chip */}
        <View
          style={{
            flexDirection: 'row',
            alignItems: 'center',
        ...
        >
          ...
          {/* Status chip — runtime background color, not a pressable element */}
          <View
            style={{
        ...
        {/* Two-layer bar: allocation track with spend fill inside */}
        <View
          style={{
            height: ms(8),
        ...
        >
          {/* Allocation bar (clamped 0–1 via barPct) */}
          <View
            style={{
              height: '100%',
              width: `${barPct * 100}%`,
          ...
          >
            {/* Spend fill inside the allocation bar */}
            <View
              style={{
                height: '100%',
