...
| Card shadow | None (original had no shadow) | HeroUI default `shadow-overlay` | Removed by not including it in the `Dialog.Content` className. No-shadow is preserved. |
