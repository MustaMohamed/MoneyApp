...
- [x] **Step 1: Write deterministic query-key tests**
...
- [x] **Step 2: Run the query-key test and verify RED**
...
- [x] **Step 3: Implement normalized query keys**
...
- [x] **Step 4: Run the query-key test and verify GREEN**

Run: `npm test -- --runInBand __tests__/transactions/transaction_query.test.ts`

Expected: PASS.

- [x] **Step 5: Write failing store transition tests**
...
- [x] **Step 6: Run the store tests and verify RED**
...
- [x] **Step 7: Implement the snapshot state machine**
...
- [x] **Step 8: Run focused store tests and verify GREEN**
...
- [x] **Step 2: Run screen-state tests and verify RED**
...
- [x] **Step 3: Implement explicit UI state actions**
...
- [x] **Step 4: Write failing hook tests for query ownership and lifecycle**
...
- [x] **Step 6: Refactor the transactions hook**
...
- [x] **Step 7: Write failing screen rendering tests**
...
- [x] **Step 8: Run screen tests and verify RED**
...
- [x] **Step 9: Implement declarative list/error rendering**
...
- [x] **Step 10: Run Task 2 tests and verify GREEN**
...
- [x] **Step 1: Write failing detail state/store tests**
...
- [x] **Step 2: Run detail state/store tests and verify RED**
...
- [x] **Step 3: Implement explicit detail state actions**
...
- [x] **Step 4: Write failing detail hook tests**
...
- [x] **Step 5: Run detail hook tests and verify RED**
...
- [x] **Step 6: Refactor detail loading behavior**
...
- [x] **Step 7: Write failing detail screen tests**
...
- [x] **Step 8: Run detail screen tests and verify RED**
...
- [x] **Step 9: Implement stable detail rendering**
...
- [x] **Step 10: Run Task 3 tests and verify GREEN**
...
- [x] **Step 2: Run lifecycle state tests and verify RED**
...
- [x] **Step 3: Implement save-aware state transitions**
...
- [x] **Step 4: Write failing hook and sheet tests**
...
- [x] **Step 5: Run hook/sheet tests and verify RED**
...
- [x] **Step 6: Extend the project Sheet contract if needed**
...
- [x] **Step 7: Refactor add/edit completion ownership**
...
- [x] **Step 8: Run Task 4 tests and verify GREEN**
...
- [x] **Step 1: Add cross-state regression tests**
...
- [x] **Step 2: Run the transaction regression suite**
...
- [x] **Step 3: Run formatter, lint, and typecheck**
...
- [x] **Step 5: Run full local CI parity before push**
...
- [x] **Step 6: Commit final test/format adjustments**
